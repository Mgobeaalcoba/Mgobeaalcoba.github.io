...
if (!supabaseUrl || !supabaseServiceRoleKey || !hfToken) {
  console.error('Missing environment variables. Check .env.local (NEXT_PUBLIC_SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY and HUGGINGFACE_TOKEN are required)');
  process.exit(1);
}
