...
export const experienceData = [
    ...
    { 
        id: 13, 
        date: { es: "Feb 2026 - actualidad", en: "Feb 2026 - Present" }, 
        title: { es: "Data Science Instructor", en: "Data Science Instructor" }, 
        company: "Henry", 
        tags: ["Python", "Pandas", "NumPy", "Scikit-learn", "PyTorch", "Machine Learning"],
        description: { es: `<li>Instructor de Machine Learning y Deep Learning: Facilitación de clases teóricas y prácticas enfocadas en el ciclo de vida completo de modelos predictivos, desde la ingeniería de características hasta la implementación de arquitecturas de redes neuronales densas y modelos de ensamble.</li><li>Desarrollo de contenido educativo avanzado: Creación de materiales y proyectos prácticos sobre aprendizaje supervisado (Regresión Lineal/Logística, SVM, Naive Bayes) y no supervisado (Clustering con K-means/DBSCAN, Reducción de dimensionalidad con PCA/t-SNE) utilizando el stack profesional de Python (Pandas, Scikit-learn, PyTorch).</li><li>Mentoría técnica y acompañamiento individualizado: Asesoramiento a estudiantes en la optimización de modelos mediante técnicas de validación cruzada, búsqueda de hiperparámetros (Grid Search, Optuna) y regularización (L1/L2) para fortalecer su autonomía en la resolución de problemas reales.</li><li>Puente entre educación y práctica profesional: Integración de casos de uso reales en análisis de series temporales (ARIMA, Prophet, XGBoost) y sistemas de recomendación, garantizando que la formación esté alineada con las demandas actuales de la industria tecnológica.</li><li>Exploración de Inteligencia Artificial y Deep Learning: Evaluación y enseñanza de modelos de vanguardia, incluyendo el funcionamiento de redes neuronales feedforward, optimización de gradiente y la transición hacia la IA Generativa, manteniendo los contenidos al día con el ecosistema de IA/ML.</li><li>Compromiso con la innovación educativa: Promoción de una enseñanza basada en el pensamiento lógico y la experimentación en entornos como Deepnote, Google Colab y VS Code, fomentando el uso ético y estratégico de los datos para generar aprendizaje significativo.</li>`, en: `<li>Machine Learning and Deep Learning Instructor: Facilitating theoretical and practical classes focused on the complete lifecycle of predictive models, from feature engineering to implementing dense neural network architectures and ensemble models.</li><li>Development of advanced educational content: Creating materials and practical projects on supervised learning (Linear/Logistic Regression, SVM, Naive Bayes) and unsupervised learning (Clustering with K-means/DBSCAN, Dimensionality reduction with PCA/t-SNE) using Python's professional stack (Pandas, Scikit-learn, PyTorch).</li><li>Technical mentoring and individualized support: Advising students on model optimization through cross-validation techniques, hyperparameter search (Grid Search, Optuna), and regularization (L1/L2) to strengthen their autonomy in solving real problems.</li><li>Bridge between education and professional practice: Integration of real use cases in time series analysis (ARIMA, Prophet, XGBoost) and recommendation systems, ensuring training is aligned with current technology industry demands.</li><li>Exploration of Artificial Intelligence and Deep Learning: Evaluation and teaching of cutting-edge models, including the operation of feedforward neural networks, gradient optimization, and the transition to Generative AI, keeping content up-to-date with the AI/ML ecosystem.</li><li>Commitment to educational innovation: Promoting teaching based on logical thinking and experimentation in environments like Deepnote, Google Colab, and VS Code, encouraging the ethical and strategic use of data to generate meaningful learning.</li>` }
    },
    { 
        id: 14, 
        date: { es: "Oct 2025 - actualidad", en: "Oct 2025 - Present" }, 
        title: { es: "AI Automation Instructor", en: "AI Automation Instructor" }, 
        company: "Henry", 
        tags: ["n8n", "AI", "LLM", "Python"],
        description: { es: `<li>Instructor de Automatización e Inteligencia Artificial Generativa: Facilitación de clases teóricas y prácticas enfocadas en el uso de n8n y herramientas de GenAI para diseñar flujos automatizados, integrar APIs y desarrollar soluciones inteligentes aplicadas a distintos contextos.</li><li>Desarrollo de contenido educativo práctico y actualizado: Creación de materiales, ejercicios y proyectos que promueven la comprensión profunda de la automatización basada en low-code/no-code y el aprovechamiento estratégico de modelos de lenguaje.</li><li>Mentoría técnica y acompañamiento individualizado: Asesoramiento constante a los estudiantes para potenciar su pensamiento lógico, fomentar la experimentación y fortalecer su autonomía en la resolución de problemas reales.</li><li>Puente entre educación y práctica profesional: Integración de casos de uso reales del sector tecnológico y colaboración con expertos para garantizar una formación alineada con las demandas actuales de la industria.</li><li>Exploración y adopción de nuevas herramientas de IA: Evaluación continua de plataformas emergentes, agentes autónomos y servicios de automatización inteligente para mantener los contenidos al día con la evolución del ecosistema.</li><li>Compromiso con la innovación educativa y el aprendizaje significativo: Promoción de una enseñanza basada en la práctica, la curiosidad y el uso ético de la inteligencia artificial en la automatización de procesos.</li>`, en: `<li>Automation and Generative AI Instructor: Facilitating theoretical and practical classes focused on using n8n and GenAI tools to design automated workflows, integrate APIs, and develop intelligent solutions applied to different contexts.</li><li>Development of practical and updated educational content: Creating materials, exercises, and projects that promote deep understanding of low-code/no-code automation and the strategic use of language models.</li><li>Technical mentoring and individualized support: Constant advising to students to enhance their logical thinking, encourage experimentation, and strengthen their autonomy in solving real problems.</li><li>Bridge between education and professional practice: Integration of real use cases from the technology sector and collaboration with experts to ensure training aligned with current industry demands.</li><li>Exploration and adoption of new AI tools: Continuous evaluation of emerging platforms, autonomous agents, and intelligent automation services to keep content up-to-date with ecosystem evolution.</li><li>Commitment to educational innovation and meaningful learning: Promoting teaching based on practice, curiosity, and the ethical use of artificial intelligence in process automation.</li>` }
    },
    { 
        id: 7, 
        date: { es: "Dic 2024 - Feb 2026", en: "Dec 2024 - Feb 2026" }, 
        title: { es: "Data & Analytics Expert", en: "Data & Analytics Expert" }, 
        company: "Henry", 
        tags: ["Power BI", "Excel", "Looker Studio"],
        description: { es: `<li>Liderazgo académico en Data & Analytics: Diseño de experiencias educativas transformadoras en herramientas clave como Power BI, Excel y Looker Studio.</li><li>Diseño instruccional y estructuración de contenidos: Maquetación de cursos con enfoque pedagógico, definiendo temáticas, secuencia de aprendizaje y recursos didácticos.</li><li>Desarrollo de proyectos aplicados: Creación de proyectos integradores que promueven el aprendizaje activo y la aplicación práctica de conceptos.</li><li>Elaboración de materiales didácticos de calidad: Redacción de soluciones, ejercicios y explicaciones detalladas que fortalecen el proceso de aprendizaje.</li><li>Planificación académica estratégica: Definición de programas de curso con objetivos claros, cronograma preciso y criterios de evaluación alineados al perfil profesional buscado.</li><li>Compromiso con la excelencia educativa: Garantía de programas actualizados, relevantes y orientados a preparar a los estudiantes para desafíos reales del mercado laboral.</li><li>Innovación en la enseñanza de herramientas de análisis: Aplicación de metodologías activas para potenciar la formación en herramientas líderes del mercado.</li><li>Enfoque en la mejora continua: Iteración constante de los cursos para asegurar su pertinencia y efectividad pedagógica.</li>`, en: `<li>Academic leadership in Data & Analytics: Designing transformative educational experiences in key tools like Power BI, Excel, and Looker Studio.</li><li>Instructional design and content structuring: Course layout with a pedagogical approach, defining themes, learning sequences, and didactic resources.</li><li>Development of applied projects: Creation of integrative projects that promote active learning and the practical application of concepts.</li><li>Elaboration of quality didactic materials: Writing solutions, exercises, and detailed explanations that strengthen the learning process.</li><li>Strategic academic planning: Definition of course programs with clear objectives, precise schedules, and evaluation criteria aligned with the desired professional profile.</li><li>Commitment to educational excellence: Ensuring updated, relevant programs oriented to prepare students for real market challenges.</li><li>Innovation in teaching analytical tools: Application of active methodologies to enhance training in leading market tools.</li><li>Focus on continuous improvement: Constant iteration of courses to ensure their relevance and pedagogical effectiveness.</li>` }
    }, 
    { 
        id: 8, 
    ...
    { 
        id: 9, 
        date: { es: "Jul 2024 - actualidad", en: "Jul 2024 - Present" }, 
