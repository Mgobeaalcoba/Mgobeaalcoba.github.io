...
export const techStackData = {
    ...
    "AI & Automation": [
        "LLM", "RAG", "GitHub Copilot", "n8n", "Zapier", "Windsurf", "Cursor"
    ],
    "Cloud & DevOps": [
...
export const projectsData = [
    ...
    { 
        id: 5, 
        tags: ['Python', 'FastAPI', 'Mathematics'], 
    ...
    { 
        id: 13, 
        tags: ['Kotlin', 'Go', 'Spring', 'Google Cloud'], 
...
export const experienceData = [
    { 
        ...
        tags: ["Python", "LLM", "RAG", "TensorFlow", "Google Cloud", "Apache Airflow", "dbt", "n8n", "Zapier", "Looker", "Power BI"],
    ...
    { 
        ...
        company: "Mercado Libre", 
        tags: ["Python", "SQL", "Google Cloud", "AWS", "Power BI", "Looker", "Jira"],
...
export const educationData = [
    ...
    { 
        ...
        date: "2022 - 2023",
        tags: ["Python", "Django", "Flask", "FastAPI", "SQL", "MySQL", "PostgreSQL", "SQLite"]
    }, 
    { 
        ...
        subtitle: { es: "Ciencias de la computación", en: "Computer Science" }, 
        date: "2021 - 2022",
        tags: ["Python", "Pandas", "NumPy", "Matplotlib", "Seaborn", "SQL", "Power BI", "Tableau"]
    }, 
    { 
...
export const certificationsData = [
    ...
    { name: "Introducción a Jira para gestión de proyectos con Kanban", tags: ["Jira"] },
    ...
    { name: "Enseñanza de inglés como lengua extranjera (TEFL)", tags: [] },
    { name: "Data Champions | BigQuery and LookML", tags: ["Google Cloud", "Looker"] },
    { name: "5 minutos al dia para mejorar tu Ingles", tags: [] },
    ...
    { name: "Curso de Ética y Manejo de Datos para Data Science", tags: ["Python"] },
    ...
    { name: "Diseño de interfaz (UI) con Figma", tags: [] },
    { name: "Curso Básico de JavaScript", tags: ["JavaScript"] },
    { name: "Curso Práctico de Frontend Developer", tags: ["JavaScript"] },
    { name: "Curso de Asincronismo con JavaScript", tags: ["JavaScript"] },
    { name: "Curso de ECMAScript", tags: ["JavaScript"] },
    { name: "Curso de Frontend Developer", tags: ["JavaScript"] },
    ...
    { name: "Curso Práctico de Product Owner", tags: ["Jira", "Notion"] },
    ...
    { name: "Curso de Digital Project Management", tags: ["Jira", "Notion", "Monday"] },
    ...
    { name: "Curso de Cómo Dar y Recibir Feedback", tags: [] },
    { name: "Curso de Funciones Matemáticas para Data Science", tags: ["Python", "NumPy"] },
    { name: "Curso de PostgreSQL", tags: ["SQL", "PostgreSQL"] },
    { name: "Curso sobre la Neurociencia del Feedback", tags: [] },
    { name: "Curso de Programación Orientada a Objetos: POO", tags: ["Python", "Java", "Kotlin"] },
    { name: "Curso Fundamentos de Product Management", tags: ["Jira", "Notion"] },
    { name: "Curso de Filosofía para Managers", tags: [] },
    { name: "Curso de Herramientas para el Crecimiento Personal", tags: [] },
    { name: "Curso de Historia de Bitcoin y Criptomonedas", tags: [] },
    { name: "Curso de Motivación para Equipos de Trabajo", tags: [] },
    { name: "Curso para Desbloquear tu Creatividad", tags: [] },
    { name: "Learning Path Shipping", tags: ["Jira", "Notion"] },
    ...
    { name: "Curso de Inglés para Principiantes", tags: [] },
    ...
    { name: "Taller de Inglés para Principiantes", tags: [] },
    { name: "Curso Profesional de Git y GitHub", tags: ["Git"] },
    { name: "Curso de Comunicación Efectiva", tags: [] },
    { name: "Curso de Fundamentos de Matemáticas", tags: ["Python"] },
    { name: "Curso de Gestión Efectiva del Tiempo", tags: [] },
    { name: "Curso de Inteligencia Emocional", tags: [] },
    ...
    { name: "Curso de Estrategias para Aprender Inglés Online", tags: [] },
