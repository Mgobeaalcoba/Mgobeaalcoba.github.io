    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description: 'Automatización RPA y workflows con n8n, Python y IA para eliminar tareas manuales repetitivas.',
        },
      },
      {
        '@type': 'Offer',
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description: 'Dashboards en tiempo real, pipelines de datos y reportes automatizados con BigQuery y Looker Studio.',
        },
      },
      {
        '@type': 'Offer',
        itemOffered: {
          ...
          description: 'Mentorías individuales para profesionales de datos, ingenieros y líderes técnicos.',
        },
      },
    ],
  },
