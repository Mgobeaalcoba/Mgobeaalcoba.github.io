...
const THEME_CONFIG = {
  ...
  light: {
    ...
    topGlow:
      "radial-gradient(ellipse 80% 50% at 50% -5%, rgba(14,165,233,0.10) 0%, transparent 60%)",
...
export default function ConsultingHero({
  ...
  const TRUST_BADGES = [
    ...
    {
      icon: GraduationCap,
      text: { es: "Docente Henry & UADE", en: "Teacher at Henry & UADE" },
    },
    {
      icon: Trophy,
      text: { es: "15+ proyectos exitosos", en: "15+ successful projects" },
    },
  ];
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        ...
        >
          ...
          <motion.div
            ...
            style={{ rotate: -45 }}
          >
            <Rocket size={116} strokeWidth={1.1} className={tc.rocketClass} />
          </motion.div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-12">
            ...
            <a href="/recursos#roi" className="btn-premium-secondary group">
              <TrendingUp
                size={20}
                className="group-hover:scale-110 transition-transform text-sky-400"
              />
              {lang === "es" ? "Simular ROI" : "Simulate ROI"}
            </a>
          </div>
